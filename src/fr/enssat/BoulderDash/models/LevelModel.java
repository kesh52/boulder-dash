...
public abstract class LevelModel extends Observable implements Runnable {
    ...
    protected LevelLoadHelper levelLoadHelper;
    private RockfordModel rockford;
    protected GameInformationModel gameInformationModel;
     ...
     */
    protected void initThreadAnimator() {
