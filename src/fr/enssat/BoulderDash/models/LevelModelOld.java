 ...
 * @since 2015-06-19
 */
public class LevelModelOld extends Observable implements Runnable {
	 ...
	 */
	public LevelModelOld(String levelName, AudioLoadHelper audioLoadHelper, String mode) {
     ...
     * @param  audioLoadHelper  Audio load helper
     */
    public LevelModelOld(String levelName, AudioLoadHelper audioLoadHelper) {
	 ...
	 * @param audioLoadHelper  Audio load helper
	 */
	public LevelModelOld(AudioLoadHelper audioLoadHelper) {
		this.audioLoadHelper = audioLoadHelper;
